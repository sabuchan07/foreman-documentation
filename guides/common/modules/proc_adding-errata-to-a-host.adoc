...
. Using the verticl ellipsis icon of the errata you want to add to the host, select *Apply via Remote Execution* to use Remote Execution, or select *Apply via customized remote execution* if you want to customize the remote execution.
Select *Apply via Katello agent* if you have no connectivity to the target host using Script.
. Click *Submit*.
